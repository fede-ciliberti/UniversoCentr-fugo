...
def main():
    ...
    print("   python computational_implementation/simulations/install_simulation_deps.py")
    print()
    print("2. Test de rendimiento:")
    print("   python computational_implementation/analysis_tools/test_performance.py")
    print()
    print("3. Generar datos iniciales (si no está hecho):")
    print("   python computational_implementation/simulations/setup_numerical_simulation.py")
    print()
